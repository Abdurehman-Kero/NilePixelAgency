    ...
    <AdminLayout title="Careers & Job Postings">
      <div className="flex gap-4 mb-6">
        <button 
          ...
          className={`px-4 py-2 rounded-xl text-xs font-bold transition-colors ${activeTab === 'jobs' ? 'bg-[#00E599] text-[#0A1220]' : 'bg-[#1B2B44] text-white hover:bg-[#23344F]'}`}
        >
          Job Postings
        </button>
        <button 
          onClick={() => setActiveTab('applications')}
          className={`px-4 py-2 rounded-xl text-xs font-bold transition-colors ${activeTab === 'applications' ? 'bg-[#00E599] text-[#0A1220]' : 'bg-[#1B2B44] text-white hover:bg-[#23344F]'}`}
        >
          Applications
        </button>
      </div>
      ...
      {activeTab === 'jobs' && (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <button onClick={() => openModal()} className="px-4 py-2 bg-[#0F6FFF] hover:bg-[#0F6FFF]/90 text-white rounded-xl text-xs font-bold flex items-center gap-2 transition-colors">
          ...
          <div className="bg-[#0A1220] border border-[#1B2B44] rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6 space-y-6">
            ...
            <form onSubmit={handleSave} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-[#1B2B44]">
                <button type="button" onClick={() => setIsModalOpen(false)} className="px-4 py-2 rounded-xl text-white font-bold hover:bg-[#1B2B44] transition-colors">Cancel</button>
                <button type="submit" className="px-4 py-2 rounded-xl bg-[#0F6FFF] hover:bg-[#0F6FFF]/90 text-white font-bold transition-colors">Save Job Posting</button>
              </div>
            </form>
          </div>
        </div>
