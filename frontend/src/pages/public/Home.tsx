...
export const Home: React.FC = () => {
 ...
 {/* Grid Background */}
 <div 
 className="absolute inset-0 bg-[size:3rem_3rem] [mask-image:radial-gradient(ellipse_70%_80%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none"
 style={{
 backgroundImage: `linear-gradient(to right, ${accentHex}20 1px, transparent 1px), linear-gradient(to bottom, ${accentHex}20 1px, transparent 1px)`
 }}
 />
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full border bg-[#0E1828]/90 text-xs font-semibold shadow-sm" style={{ borderColor: `${accentHex}50`, color: accentHex }}>
 ...
 <Link to="/contact" className="px-5 py-2 sm:px-8 sm:py-3.5 rounded-full font-bold transition-all transform hover:scale-105 text-white" style={{ backgroundColor: accentHex }}>
 Start your project
 </Link>
 <Link to="/contact" className="px-5 py-2 sm:px-8 sm:py-3.5 rounded-full font-bold transition-all transform hover:scale-105 bg-transparent border-2 text-white" style={{ borderColor: accentHex }}>
