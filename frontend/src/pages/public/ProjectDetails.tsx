...
export const ProjectDetails: React.FC = () => {
  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-12 text-white">
      <Link to="/projects" className="inline-flex items-center gap-2 text-sm font-semibold text-[#00E599] hover:underline transition-all">
              ...
              <div className="pt-6 flex flex-col gap-3 border-t border-[#1B2B44]/50">
                {p.live_url && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#00E599] text-[#04080F] hover:bg-[#00E599]/90 font-bold rounded-xl transition-transform hover:scale-[1.02]"
                  >
                ...
                {p.github_url && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer" 
                    className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#1B2B44] text-white hover:bg-[#23344F] font-bold rounded-xl transition-transform hover:scale-[1.02] border border-[#23344F]"
                  >
