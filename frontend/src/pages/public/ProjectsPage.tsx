...
export const ProjectsPage: React.FC = () => {
  ...
  return (
    <div className="py-24 px-4 sm:px-6 lg:px-8 min-h-screen bg-[#04080F] relative text-white">
      {/* Subtle grid background to match screenshot */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#00E599_1px,transparent_1px),linear-gradient(to_bottom,#00E599_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] opacity-[0.03] pointer-events-none" />
