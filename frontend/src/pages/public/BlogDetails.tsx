...
export const BlogDetails: React.FC = () => {
 ...
 return (
 <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto space-y-8 text-white relative">
 ...
 <Link to="/blog" className="relative z-10 inline-flex items-center gap-2 text-xs text-[#00A3FF] hover:underline">
