...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-white space-y-12">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#0F6FFF] to-[#00A3FF] font-bold text-white transition flex items-center justify-center gap-2 shadow-lg"
              >
